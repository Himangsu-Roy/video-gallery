...
/***/ "./src/blocks/video-slider/Components/Common/Style.js":
/*!************************************************************!*\
  !*** ./src/blocks/video-slider/Components/Common/Style.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", items?.title?.typography)?.googleFontLink}
		

		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(slideTitleSl, items?.title?.typography)?.styles}
		...
		${slideDotsSl}{
		  ...
		  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.dots?.margin?.desktop)};
		}
		...
		${slideDotSl}{
			...
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.dots?.borderRadius?.desktop)};
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderCSS)(items?.dots?.border)}
			box-shadow: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(items?.dots?.shadow)};
		}

		${slideDotActiveSl}{
		   background-color: ${items?.dots?.bgActiveColor};
		   transform: scale(${items?.dots?.activeScaleEffect});
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderCSS)(items?.dots?.activeBorder)}
		}
		...
		${videoSliderWrapperSl} .nav-button {
			...
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.navigation?.padding?.desktop)};
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderCSS)(items?.navigation?.border)}
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.navigation?.borderRadius?.desktop)};
			box-shadow: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(items?.navigation?.shadow)};
		...
		${videoSliderWrapperSl} .nav-button:hover {
			...
			box-shadow: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(items?.navigation?.hoverShadow)};
			
		}

		${slidePlayButtonSl}{
			background-color: ${items?.playBtn?.bg};
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.playBtn?.borderRadius)};
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.playBtn?.padding)};
			box-shadow: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(items?.playBtn?.shadow)};
		}

		${slidePlayButtonSl}:hover{
			background-color: ${items?.playBtn?.bgHoverColor};
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.playBtn?.hoverPadding)};
		...
		${slideStarsSl}{
		  ...
		  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.rating?.margin?.desktop)};
		}
		...
		${slideTitleSl}{
		  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.title?.margin?.desktop)};
		...
		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.tabBreakpoint} {
		  ...
		  ${slideTitleSl}{
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.title?.margin?.tablet)};
		  }
		  ...
		  ${slideDotsSl}{
			...
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.dots?.margin?.tablet)};
		  }

		  ${slideDotSl}{
			width: ${items?.dots?.size?.tablet};
			height: ${items?.dots?.size?.tablet};
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.dots?.borderRadius?.tablet)};
		  }
		  ...
		  ${videoSliderWrapperSl} .nav-button {
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.navigation?.padding?.tablet)};
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.navigation?.borderRadius?.tablet)};
		  ...
		  ${slideStarsSl}{
			...
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.rating?.margin?.tablet)};
		  }
		...
		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.mobileBreakpoint} {
		  ...
		  ${slideTitleSl}{
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.title?.margin?.mobile)};
		  }
		  ...
		  ${slideDotsSl}{
			...
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.dots?.margin?.mobile)};
		  }
		  ...
		  ${videoSliderWrapperSl} .nav-button {
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.navigation?.padding?.mobile)};
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.navigation?.borderRadius?.mobile)};
		  ...
		  ${slideStarsSl}{
			...
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.rating?.margin?.mobile)};
		  }
...
/***/ "./src/blocks/video-slider/Components/Common/VideoSlider/VideoSlider.js":
/*!******************************************************************************!*\
  !*** ./src/blocks/video-slider/Components/Common/VideoSlider/VideoSlider.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/star.js");
...
const VideoSlider = ({
  ...
  const [currentIndex, setCurrentIndex] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(2);
  const [isPlaying, setIsPlaying] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  const [videoLoadingStates, setVideoLoadingStates] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({});
  const videoRefs = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)([]);
  const {
    videos: testimonials,
    items
  } = attributes;
  ...
  const renderStars = rating => [...Array(5)].map((_, i) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(lucide_react__WEBPACK_IMPORTED_MODULE_1__["default"], {
    key: i,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    ...
    className: "video-slider__container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "video-slider__wrapper"
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: `slide ${isCenter ? "slide--center" : isAdjacent ? "slide--adjacent" : "slide--side"} ${originalIndex === activeIndex ? "bPlNowEditing" : ""}`,
      onClick: () => {
    ...
    }, videoLoadingStates[originalIndex] && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }), isPlaying !== originalIndex && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "slide__play-overlay"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      dangerouslySetInnerHTML: {
      ...
      className: "title"
    }, testimonial?.title), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "stars"
    }, renderStars(testimonial?.rating)))));
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "dots"
  }, testimonials.map((_, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    key: index,
...
/***/ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/star.js":
/*!***********************************************************************!*\
  !*** ../plugin-slug/node_modules/lucide-react/dist/esm/icons/star.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/video-slider/style.scss":
/*!********************************************!*\
  !*** ./src/blocks/video-slider/style.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!*****************************************!*\
  !*** ./src/blocks/video-slider/view.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/video-slider/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/video-slider/Components/Common/Style.js");
/* harmony import */ var _Components_Common_VideoSlider_VideoSlider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/VideoSlider/VideoSlider */ "./src/blocks/video-slider/Components/Common/VideoSlider/VideoSlider.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-vgblk-video-slider");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), isPremium ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_VideoSlider_VideoSlider__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "wp-block-vsl-video-slider-pro"
