...
/***/ "./src/blocks/video-testimonial-section/Components/Common/Style.js":
/*!*************************************************************************!*\
  !*** ./src/blocks/video-testimonial-section/Components/Common/Style.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", items?.title?.typography)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", items?.subtitle?.typography)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", items?.controls?.typography)?.googleFontLink}
		

		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(vpTitleSl, items?.title?.typography)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(vpSubtitleSl, items?.subtitle?.typography)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(vpTimeSl, items?.controls?.typography)?.styles}

 
		${vpPageSl}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBackgroundCSS)(gallery?.background)}
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderCSS)(gallery?.border)}
		  border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(gallery?.borderRadius?.desktop)};
		  box-shadow: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getMultiShadowCSS)(gallery?.shadow)};
		  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(gallery?.margin?.desktop)};
		}
	

		${vpPlayButtonSl}{
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.controls?.playPauseBtn?.borderRadius?.desktop)};
			...
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderCSS)(items?.controls?.playPauseBtn?.border)}
		}
		...
		${vpProgressSl}::-webkit-slider-thumb {
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderCSS)(items?.controls?.progressBar?.sliderThumb?.border)}
	      border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.controls?.progressBar?.sliderThumb?.borderRadius)};
		}
		...
		${vpControlsOverlaySl}{
		  padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.controls?.padding?.desktop)};
		  background: linear-gradient(to top, ${items?.controls?.overlayColor}, transparent);
		}

		${vpCardSl}{
		  border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.borderRadius?.desktop)};
		  background: ${items?.background?.color};
		  box-shadow: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getMultiShadowCSS)(items?.shadow)};
		}

		${vpInfoSl}{
		  padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.info?.padding?.desktop)};																												
		}

		${vpTitleSl}{
		  color: ${items?.title?.color};
		  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.title?.margin?.desktop)};
		}

		${vpContainerSl}{
			max-width: ${gallery?.container?.maxWidth}px;
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(gallery?.padding?.desktop)};
		}

		${vpSubtitleSl}{
		  color: ${items?.subtitle?.color};
		  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.subtitle?.margin?.desktop)};
		}
		...
		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_2__.tabBreakpoint} {
			${vpGridSl} {
			...
			${vpPlayButtonSl}{
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.controls?.playPauseBtn?.borderRadius?.tablet)};
		 ...
		 height: ${items?.controls?.iconSize.tablet};
	  	...
	  	${vpControlsOverlaySl}{
		  padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.controls?.padding?.tablet)};
		}

		${vpCardSl}{
		  border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.borderRadius?.tablet)};
		}


		${vpInfoSl}{
		  padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.info?.padding?.tablet)};																												
		}

		${vpTitleSl}{
		  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.title?.margin?.tablet)};
		}

		${vpContainerSl}{
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(gallery?.padding?.tablet)};
		}

		${vpSubtitleSl}{
		  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.subtitle?.margin?.tablet)};
		}

		${vpPageSl}{
		  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(gallery?.margin?.tablet)};
		  border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(gallery?.borderRadius?.tablet)};
		}
	}

		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_2__.mobileBreakpoint} {
			${vpVideoSl} {
			...
			${vpPlayButtonSl}{
				border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.controls?.playPauseBtn?.borderRadius?.mobile)};
			...
			${vpControlsOverlaySl}{
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.controls?.padding?.mobile)};
			}

			${vpCardSl}{
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.borderRadius?.mobile)};
			}

			${vpInfoSl}{
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.info?.padding?.mobile)};																												
			}

			${vpTitleSl}{
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.title?.margin?.mobile)};
			}

			${vpContainerSl}{
				padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(gallery?.padding?.mobile)};
			}

			${vpSubtitleSl}{
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(items?.subtitle?.margin?.mobile)};
			}

			${vpPageSl}{
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(gallery?.margin?.mobile)};
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(gallery?.borderRadius?.mobile)};
			}
...
/***/ "./src/blocks/video-testimonial-section/Components/Common/VideoTestimonialSection/VideoTestimonialSection.js":
/*!*******************************************************************************************************************!*\
  !*** ./src/blocks/video-testimonial-section/Components/Common/VideoTestimonialSection/VideoTestimonialSection.js ***!
  \*******************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/skip-back.js");
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/pause.js");
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/play.js");
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/skip-forward.js");
...
function VideoPlayer({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    src: video.video,
    type: "video/mp4"
  })), (isHovering || isPlaying) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "vp-time"
  }, formatTime(currentTime), " / ", formatTime(duration))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "range",
    min: "0",
    max: "100",
...
function VideoTestimonialSection({
  ...
  const [activeVideo, setActiveVideo] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "vp-grid"
  }, videos.map((video, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(VideoPlayer, {
    key: instanceId ? `${instanceId}-${video?.id}-${videos.length}` : `${video.id}-${videos.length}`,
    index: index,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VideoTestimonialSection);
...
/***/ "./src/blocks/video-testimonial-section/style.scss":
/*!*********************************************************!*\
  !*** ./src/blocks/video-testimonial-section/style.scss ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!******************************************************!*\
  !*** ./src/blocks/video-testimonial-section/view.js ***!
  \******************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/video-testimonial-section/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/video-testimonial-section/Components/Common/Style.js");
/* harmony import */ var _Components_Common_VideoTestimonialSection_VideoTestimonialSection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/VideoTestimonialSection/VideoTestimonialSection */ "./src/blocks/video-testimonial-section/Components/Common/VideoTestimonialSection/VideoTestimonialSection.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-vgblk-video-testimonial-section");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), isPremium ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_VideoTestimonialSection_VideoTestimonialSection__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "wp-block-vts-video-testimonial-section-pro"
