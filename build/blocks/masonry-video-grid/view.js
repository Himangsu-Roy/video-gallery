...
/***/ "./src/blocks/masonry-video-grid/Components/Common/MasonryVideoGrid/Grid/MasonryGrid1.js":
/*!***********************************************************************************************!*\
  !*** ./src/blocks/masonry-video-grid/Components/Common/MasonryVideoGrid/Grid/MasonryGrid1.js ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Lightbox_Lightbox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Lightbox/Lightbox */ "./src/blocks/masonry-video-grid/Components/Common/MasonryVideoGrid/Lightbox/Lightbox.js");
...
const MasonryGrid1 = ({
  ...
  const [playingIndex, setPlayingIndex] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  ...
  const [durations, setDurations] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({});
  const [activeVideoLoaded, setActiveVideoLoaded] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({});
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mvg-grid-1"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `mvg-grid-1-columns`
  }, videos.map((video, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: `${video.id}-${index}`,
    "data-video-id": video.id,
    className: `mvg-grid-1-card ${activeIndex === index ? "bPlNowEditing" : ""} ${video.height !== "custom" ? `h-${video.height}` : ""} ${playingIndex === index ? "playing" : ""}`,
    onClick: () => {
      handleCardClick(video, index);
      setActiveIndex(index);
    }
  }, playingIndex === index && !activeVideoLoaded[index] && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    // preload="none"
    ,
    onLoadStart: () => setActiveVideoLoaded(prev => ({
      ...prev,
      [index]: false
    })),
    onWaiting: () => setActiveVideoLoaded(prev => ({
      ...prev,
      [index]: false
    })),
    onCanPlay: () => setActiveVideoLoaded(prev => ({
      ...prev,
      [index]: true
    })),
    onPlaying: () => setActiveVideoLoaded(prev => ({
      ...prev,
      [index]: true
    })),
    ...
    className: `mvg-grid-1-card-overlay ${playingIndex === index ? "hidden-overlay" : ""}`
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mvg-grid-1-card-play-btn"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "btn-inner",
    dangerouslySetInnerHTML: {
      __html: items?.playBtn?.icon
    }
  })), items?.video?.showMinutes && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mvg-grid-1-card-duration"
  }, durations[index] || "0:00"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mvg-grid-1-card-info"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", {
    className: "mvg-grid-1-card-title"
  }, video.title))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Lightbox_Lightbox__WEBPACK_IMPORTED_MODULE_1__["default"], {
    isOpen: lightboxOpen,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MasonryGrid1);

/***/ }),

/***/ "./src/blocks/masonry-video-grid/Components/Common/MasonryVideoGrid/Lightbox/Lightbox.js":
/*!***********************************************************************************************!*\
  !*** ./src/blocks/masonry-video-grid/Components/Common/MasonryVideoGrid/Lightbox/Lightbox.js ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/x.js");
...
const Lightbox = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "mvg-lightbox-content"
  }, showCloseButton && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    ...
    size: parseInt(closeButtonSize) * 0.6
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("video", {
    ref: videoRef,
    ...
    loop: true,
    playsInline: true
  }), video.title && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mvg-lightbox-info"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, video.title))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Lightbox);

/***/ }),

/***/ "./src/blocks/masonry-video-grid/Components/Common/MasonryVideoGrid/MasonryVideoGrid.js":
/*!**********************************************************************************************!*\
  !*** ./src/blocks/masonry-video-grid/Components/Common/MasonryVideoGrid/MasonryVideoGrid.js ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Grid_MasonryGrid1__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Grid/MasonryGrid1 */ "./src/blocks/masonry-video-grid/Components/Common/MasonryVideoGrid/Grid/MasonryGrid1.js");


function MasonryVideoGrid({
  attributes,
  activeIndex,
  setActiveIndex
}) {
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mvg-wrapper"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mvg-wrapper-content"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Grid_MasonryGrid1__WEBPACK_IMPORTED_MODULE_1__["default"], {
    attributes: attributes,
    activeIndex: activeIndex,
    setActiveIndex: setActiveIndex
  })));
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MasonryVideoGrid);

/***/ }),

/***/ "./src/blocks/masonry-video-grid/Components/Common/Style.js":
/*!******************************************************************!*\
  !*** ./src/blocks/masonry-video-grid/Components/Common/Style.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(mvgGrid1CardTitleSl, items?.title?.typography)?.styles}
...
/***/ "./src/blocks/masonry-video-grid/style.scss":
/*!**************************************************!*\
  !*** ./src/blocks/masonry-video-grid/style.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!***********************************************!*\
  !*** ./src/blocks/masonry-video-grid/view.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/masonry-video-grid/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/masonry-video-grid/Components/Common/Style.js");
/* harmony import */ var _Components_Common_MasonryVideoGrid_MasonryVideoGrid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/MasonryVideoGrid/MasonryVideoGrid */ "./src/blocks/masonry-video-grid/Components/Common/MasonryVideoGrid/MasonryVideoGrid.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-vgblk-masonry-video-grid-one");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      attributes: attributes,
      id: blockNameEl.id
    }), isPremium ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_MasonryVideoGrid_MasonryVideoGrid__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "wp-block-mvg-masonry-video-grid-pro"
