...
/***/ "./src/blocks/video-carousel-gallery/Components/Common/Style.js":
/*!**********************************************************************!*\
  !*** ./src/blocks/video-carousel-gallery/Components/Common/Style.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
        ...
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", items?.info?.title?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", items?.info?.productPricing?.currentPrice?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", items?.info?.productPricing?.originalPrice?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", lightbox?.productInfo?.title?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", lightbox?.productInfo?.productPricing?.currentPrice?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", lightbox?.productInfo?.productPricing?.originalPrice?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", lightbox?.productInfo?.shopButton?.typography)?.googleFontLink}


        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(vcgVideoCardProductNameSl, items?.info?.title?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(vcgVideoCardProductCurrentPriceSl, items?.info?.productPricing?.currentPrice?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(vcgVideoCardProductPriceSl, items?.info?.productPricing?.originalPrice?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(vcgProductInfoNameSl, lightbox?.productInfo?.title?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(vcgProductInfoCurrentSl, lightbox?.productInfo?.productPricing?.currentPrice?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(vcgProductInfoOriginalSl, lightbox?.productInfo?.productPricing?.originalPrice?.typography)?.styles}

        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(vcgShopButtonSl, lightbox?.productInfo?.shopButton?.typography)?.styles}


        ${vcgVideoCardProductPriceSl} svg{
        width: ${items?.info?.productPricing?.originalPrice?.currencySize?.desktop};
          height: ${items?.info?.productPricing?.originalPrice?.currencySize?.desktop};
          fill: ${items?.info?.productPricing?.originalPrice?.color};
        }

        ${vcgVideoCardProductCurrentPriceSl} svg{
          width: ${items?.info?.productPricing?.currentPrice?.currencySize?.desktop};
          height: ${items?.info?.productPricing?.currentPrice?.currencySize?.desktop};
          fill: ${items?.info?.productPricing?.currentPrice?.color};
        }


        ${vcgProductInfoOriginalSl} svg{
          width: ${lightbox?.productInfo?.productPricing?.originalPrice?.currencySize?.desktop};
          height: ${lightbox?.productInfo?.productPricing?.originalPrice?.currencySize?.desktop};
          fill: ${lightbox?.productInfo?.productPricing?.orginalPrice?.color};
        }


        ${vcgProductInfoCurrentSl} svg{
          width: ${lightbox?.productInfo?.productPricing?.currentPrice?.currencySize?.desktop};
          height: ${lightbox?.productInfo?.productPricing?.currentPrice?.currencySize?.desktop};
        ...
        ${vcgLightboxCloseButtonSl}{
          ...
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.closeButton?.borderRadius?.desktop)};
        }
        ...
        ${vcgShopButtonSl}{
          background-color: ${lightbox?.productInfo?.shopButton?.backgroundColor};
          color: ${lightbox?.productInfo?.shopButton?.textColor};
          padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.shopButton?.padding?.desktop)};
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.shopButton?.borderRadius?.desktop)};
        }
        ...
        ${vcgProductInfoNameSl}{
          ...
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.title?.margin?.desktop)};
        }


        ${vcgProductInfoWrapperSl}{
          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(lightbox?.infoWrapper?.background)}
          padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.infoWrapper?.padding?.desktop)};
        }
        ...
        ${vcgProductInfoCardSl} img{
          ...
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.productImage?.borderRadius?.desktop)};
        }


        ${vcgProductInfoCardSl}{
          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(lightbox?.productInfo?.background)}
          backdrop-filter: blur(${lightbox?.productInfo?.blur}px);
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.borderRadius?.desktop)};
          padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.padding?.desktop)};
        ...
        ${vcgMuteButtonSl}, ${vcgMainVideoWrapperSl} .vcg-nav-button{
          ...
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.buttons?.borderRadius?.desktop)};
        }
        ...
        ${vcgVideoContainerSl}, ${vcgLightboxPreviewThumbnailRightSl}, ${vcgLightboxPreviewThumbnailLeftSl} {
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.borderRadius?.desktop)}; 
          height: ${lightbox?.height?.desktop};
        }

        ${vcgLightboxSl}{
          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(lightbox?.background)}
        }

        ${vcgCarouselContainerSl}{
          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(gallery?.background)}
        ...
        ${vcgCarouselCardsSl}{
          ...
          padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.padding?.desktop)};
        }
        ...
        ${vcgVideoCardProductNameSl}{
          ...
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.title?.margin?.desktop)};
        }
        ...
        ${vcgVideoCardProductCurrentPriceSl}{
          ...
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.productPricing?.currentPrice?.margin?.desktop)};
        }

        ${vcgVideoCardProductPriceSl}{
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.productPricing?.originalPrice?.margin?.desktop)};
          color: ${items?.info?.productPricing?.originalPrice?.color};
        }

        ${vcgVideoCardInfoSl}{
          padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.padding?.desktop)};
          gap: ${items?.info?.gap?.desktop};
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.borderRadius?.desktop)};
        }

        ${vcgVideoCardInfoSl} img{
          width: ${items?.info?.productImage?.size};
          height: ${items?.info?.productImage?.size};
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.productImage?.borderRadius?.desktop)};
        }
        ...
        ${vcgCarouselVideoPreviewSl}{
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.preview?.borderRadius?.desktop)};
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.preview?.margin?.desktop)};
        }
        ...
        ${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.tabBreakpoint}{
          ${vcgLightboxCloseButtonSl}{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.closeButton?.borderRadius?.tablet)};
          }   

          ${vcgShopButtonSl}{
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.shopButton?.padding?.tablet)};
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.shopButton?.borderRadius?.tablet)};
          }
          ...
          ${vcgProductInfoNameSl}{
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.title?.margin?.tablet)};
          }


          ${vcgProductInfoWrapperSl}{
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.infoWrapper?.padding?.tablet)};
          }


          ${vcgProductInfoCardSl} img{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.productImage?.borderRadius?.tablet)};
          }


          ${vcgProductInfoCardSl}{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.borderRadius?.tablet)};
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.padding?.tablet)};
            gap: ${lightbox?.productInfo?.gap?.tablet};
          }

          ${vcgMuteButtonSl}, ${vcgMainVideoWrapperSl} .vcg-nav-button{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.buttons?.borderRadius?.tablet)};
          }
          ...
          ${vcgVideoContainerSl}, ${vcgLightboxPreviewThumbnailRightSl}, ${vcgLightboxPreviewThumbnailLeftSl} {
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.borderRadius?.tablet)}; 
            height: ${lightbox?.height?.tablet};
          }
          ...
          ${vcgCarouselCardsSl}{
            ...
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.padding?.tablet)};
          }
          ...
          ${vcgVideoCardProductNameSl}{
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.title?.margin?.tablet)};
          }
          ...
          ${vcgVideoCardProductCurrentPriceSl}{
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.productPricing?.currentPrice?.margin?.tablet)};
          }

          ${vcgVideoCardProductPriceSl}{
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.productPricing?.originalPrice?.margin?.tablet)};
          }

          ${vcgVideoCardInfoSl}{
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.padding?.tablet)};
            gap: ${items?.info?.gap?.tablet};
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.borderRadius?.tablet)};
          }

          ${vcgVideoCardInfoSl} img{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.productImage?.borderRadius?.tablet)};
          }

          ${vcgCarouselVideoPreviewSl}{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.preview?.borderRadius?.tablet)};
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.preview?.margin?.tablet)};
          }
        }
        ...
        ${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.mobileBreakpoint}{
          ${vcgLightboxCloseButtonSl}{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.closeButton?.borderRadius?.mobile)};
          }   

          ${vcgShopButtonSl}{
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.shopButton?.padding?.mobile)};
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.shopButton?.borderRadius?.mobile)};
          }
          ...
          ${vcgProductInfoNameSl}{
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.title?.margin?.mobile)};
          }


          ${vcgProductInfoWrapperSl}{
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.infoWrapper?.padding?.mobile)};
          }


          ${vcgProductInfoCardSl} img{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.productImage?.borderRadius?.mobile)};
          }


          ${vcgProductInfoCardSl}{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.borderRadius?.mobile)};
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.productInfo?.padding?.mobile)};
            gap: ${lightbox?.productInfo?.gap?.mobile};
          }

          ${vcgMuteButtonSl}, ${vcgMainVideoWrapperSl} .vcg-nav-button{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.buttons?.borderRadius?.mobile)};
          }
          ...
          ${vcgVideoContainerSl}, ${vcgLightboxPreviewThumbnailRightSl}, ${vcgLightboxPreviewThumbnailLeftSl} {
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(lightbox?.borderRadius?.mobile)}; 
            height: ${lightbox?.height?.mobile};
          }
          ...
          ${vcgCarouselCardsSl}{
            ...
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.padding?.mobile)};
          }
          ...
          ${vcgVideoCardProductNameSl}{
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.title?.margin?.mobile)};
          }
          ...
          ${vcgVideoCardProductCurrentPriceSl}{
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.productPricing?.currentPrice?.margin?.mobile)};
          }

          ${vcgVideoCardProductPriceSl}{
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.productPricing?.originalPrice?.margin?.mobile)};
          }

          ${vcgVideoCardInfoSl}{
            padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.padding?.mobile)};
            gap: ${items?.info?.gap?.mobile};
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.borderRadius?.mobile)};
          }

          ${vcgVideoCardInfoSl} img{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.info?.productImage?.borderRadius?.mobile)};
          }

          ${vcgCarouselVideoPreviewSl}{
            border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.preview?.borderRadius?.mobile)};
            margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(items?.preview?.margin?.mobile)};
          }
        }
...
/***/ "./src/blocks/video-carousel-gallery/Components/Common/VideoCarouselGallery/VideoCard.js":
/*!***********************************************************************************************!*\
  !*** ./src/blocks/video-carousel-gallery/Components/Common/VideoCarouselGallery/VideoCard.js ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _hooks_useWooCommerceProduct__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../hooks/useWooCommerceProduct */ "./src/blocks/video-carousel-gallery/hooks/useWooCommerceProduct.js");
...
const VideoCard = ({
  ...
  var _options$autoPlay, _options$loop;
  const videoRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const autoPlay = (_options$autoPlay = options?.autoPlay) !== null && _options$autoPlay !== void 0 ? _options$autoPlay : true;
  const loop = (_options$loop = options?.loop) !== null && _options$loop !== void 0 ? _options$loop : true;
  ...
  const {
    ...
    loading: wooLoading,
    error: wooError
  } = (0,_hooks_useWooCommerceProduct__WEBPACK_IMPORTED_MODULE_1__["default"])(product?.product_id, product?.woocommerce_enabled);
    ...
    if (videoRef.current) {
      ...
      if (autoPlay) {
        ...
        if (playPromise !== undefined) {
          playPromise.then(() => setIsLoading(false)).catch(error => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `vcg-video-card ${index === activeIndex ? "bPlNowEditing" : ""}`,
    onClick: handleClick
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-video-preview"
    ...
    className: "vcg-product-details"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", {
    className: "vcg-product-name"
  }, displayProduct?.title), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-product-pricing"
  }, displayProduct?.original_price && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "vcg-original-price",
    style: {
      display: "flex"
    }
  ...
  }), displayProduct?.original_price), displayProduct?.price && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "vcg-current-price",
    style: {
      display: "flex"
    }
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
...
/***/ "./src/blocks/video-carousel-gallery/Components/Common/VideoCarouselGallery/VideoCarouselGallery.js":
/*!**********************************************************************************************************!*\
  !*** ./src/blocks/video-carousel-gallery/Components/Common/VideoCarouselGallery/VideoCarouselGallery.js ***!
  \**********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _VideoCard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./VideoCard */ "./src/blocks/video-carousel-gallery/Components/Common/VideoCarouselGallery/VideoCard.js");
/* harmony import */ var _VideoLightbox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./VideoLightbox */ "./src/blocks/video-carousel-gallery/Components/Common/VideoCarouselGallery/VideoLightbox.js");




const VideoCarouselGallery = ({
  attributes,
  setActiveIndex,
  activeIndex
}) => {
  ...
  const [instanceId, setInstanceId] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
  ...
  if (loading) {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "vcg-loading"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "vcg-spinner"
    }));
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-carousel-container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-carousel-inner"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "vcg-carousel-cards"
  }, products.map((product, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_VideoCard__WEBPACK_IMPORTED_MODULE_1__["default"], {
    key: instanceId ? `${instanceId}-${product.id}` : product.id,
    product: product,
    ...
    index: index
  })))))), selectedIndex !== null && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_VideoLightbox__WEBPACK_IMPORTED_MODULE_2__["default"], {
    products: products,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VideoCarouselGallery);

/***/ }),

/***/ "./src/blocks/video-carousel-gallery/Components/Common/VideoCarouselGallery/VideoLightbox.js":
/*!***************************************************************************************************!*\
  !*** ./src/blocks/video-carousel-gallery/Components/Common/VideoCarouselGallery/VideoLightbox.js ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/x.js");
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/chevron-left.js");
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/chevron-right.js");
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/volume-x.js");
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lucide-react */ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/volume-2.js");
/* harmony import */ var _hooks_useWooCommerceProduct__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../hooks/useWooCommerceProduct */ "./src/blocks/video-carousel-gallery/hooks/useWooCommerceProduct.js");
...
const VideoLightbox = ({
  ...
  var _options$autoPlay, _options$loop;
  const [currentIndex, setCurrentIndex] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(initialIndex);
  ...
  const [isDragging, setIsDragging] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const lightboxRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  ...
  const {
    ...
    loading: wooLoading,
    error: wooError
  } = (0,_hooks_useWooCommerceProduct__WEBPACK_IMPORTED_MODULE_1__["default"])(currentProduct?.product_id, currentProduct?.woocommerce_enabled);

  // Merge WooCommerce product data with manual data
  // Only use WooCommerce data if it's enabled, not loading, no error, and product exists
  const displayProduct = currentProduct?.woocommerce_enabled && wooProduct && !wooLoading && !wooError ? {
    ...currentProduct,
    title: wooProduct.title || currentProduct.title,
    price: wooProduct.price || currentProduct.price,
    original_price: wooProduct.sale_price ? wooProduct.regular_price : currentProduct.original_price,
    product_image: wooProduct.image || currentProduct.product_image,
    product_url: wooProduct.permalink || currentProduct.product_url,
    add_to_cart_url: wooProduct.add_to_cart_url || currentProduct.add_to_cart_url
  } : currentProduct;
  ...
  const handleBackgroundClick = e => {
    if (e.target.classList.contains("vcg-lightbox") || e.target.classList.contains("vcg-lightbox-content")) {
      onClose();
    }
  };
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onClick: onClose,
    className: "vcg-close-button"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(lucide_react__WEBPACK_IMPORTED_MODULE_2__["default"], {
    className: "vcg-close-icon"
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-lightbox-content"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-preview-left"
  }, currentIndex > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-preview-thumbnail"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: products[currentIndex - 1].poster,
    alt: products[currentIndex - 1].title,
    loading: "lazy"
  }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-main-video-wrapper"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
  ...
  }), displayProduct?.price))), displayProduct?.product_url && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: displayProduct?.product_url || "#",
    className: "vcg-shop-button",
    target: options?.openInNewTab ? "_blank" : "_self",
    rel: "noopener noreferrer"
  }, "Shop"))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-preview-right"
  }, currentIndex < products.length - 1 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "vcg-preview-thumbnail"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: products[currentIndex + 1].poster,
    alt: products[currentIndex + 1].title,
...
/***/ "./src/blocks/video-carousel-gallery/hooks/useWooCommerceProduct.js":
/*!**************************************************************************!*\
  !*** ./src/blocks/video-carousel-gallery/hooks/useWooCommerceProduct.js ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useWooCommerceProduct);
...
/***/ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/chevron-left.js":
/*!*******************************************************************************!*\
  !*** ../plugin-slug/node_modules/lucide-react/dist/esm/icons/chevron-left.js ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "../plugin-slug/node_modules/lucide-react/dist/esm/icons/chevron-right.js":
/*!********************************************************************************!*\
  !*** ../plugin-slug/node_modules/lucide-react/dist/esm/icons/chevron-right.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/video-carousel-gallery/style.scss":
/*!******************************************************!*\
  !*** ./src/blocks/video-carousel-gallery/style.scss ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!***************************************************!*\
  !*** ./src/blocks/video-carousel-gallery/view.js ***!
  \***************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/video-carousel-gallery/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/video-carousel-gallery/Components/Common/Style.js");
/* harmony import */ var _Components_Common_VideoCarouselGallery_VideoCarouselGallery__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/VideoCarouselGallery/VideoCarouselGallery */ "./src/blocks/video-carousel-gallery/Components/Common/VideoCarouselGallery/VideoCarouselGallery.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-vgblk-video-carousel-gallery");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), isPremium ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_VideoCarouselGallery_VideoCarouselGallery__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "wp-block-vcg-video-carousel-gallery-pro"
